// src/pages/VendedorRegisterPage.jsx
...
const VendedorRegisterPage = () => {
  ...
  const handleFinalSubmit = async (e) => {
    e.preventDefault();
    alert(
      "Cadastro de vendedor enviado para análise. Você será notificado por e-mail."
    );
  ...
  // PASSO 1: DADOS PESSOAIS E SEGURANÇA (SEM TERMOS)
  const renderStep1 = () => (
    <form onSubmit={handleNext} style={styles.form}>
      <h3 style={styles.stepTitle}>Cadastro de Vendedor - Dados Pessoais</h3>

      {/* CAMPO DE FOTO DE PERFIL OBRIGATÓRIA */}
  ...
  const renderStep2 = () => (
    <form onSubmit={handleFinalSubmit} style={styles.form}>
      <h3 style={styles.stepTitle}>Dados Bancários</h3>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.headerTitle}>Cadastro de Vendedor</h2>
...
// --- ESTILOS (MANTIDOS) ---
const styles = {
  themeColor: "#ffc107", // Amarelo para vendedor
  ...
  headerTitle: { textAlign: "center", marginBottom: "20px", color: "#ffc107" },
  ...
  activeStep: { color: "#ffc107", fontWeight: "bold" },
